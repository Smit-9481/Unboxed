...
<head>
    ...
    <title><?php echo htmlspecialchars($category['name']); ?> - UNBOXED</title>
...
<body>
    ...
    <!-- Category Header -->
    <div class="category-header py-5 bg-light">
        <div class="container">
            <h1 class="text-center mb-3"><?php echo htmlspecialchars($category['name']); ?></h1>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            ...
            <hr class="my-4">
            <div class="text-center">
                <p class="mb-0">&copy; 2024 Gift Store. All rights reserved.</p>
            </div>
        </div>
    </footer>
